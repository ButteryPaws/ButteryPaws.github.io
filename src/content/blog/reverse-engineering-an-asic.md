...
Understanding how unrolling works for circuits is something which can be helped a lot by a visual explanation. Here is a [Claude-generated artifact which explains this beautifully](/public/asic/unrolling.html).
...
## Challenges
 ...
 ![A demonstration on how compiling KLayout wrecked my computer COMPLETELY](/public/asic/compiling_klayout.png)
...
[Here is a transcript of my entire journey with AI, generated (ironically) by the same AI](/public/asic/starbattle.html)
...
![be humble](/public/asic/easy.png)
